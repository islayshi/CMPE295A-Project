export default function ScenarioController({ scenarioState, setScenarioState }) {
  ...
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-black/80 backdrop-blur-md border border-slate-700 p-2 rounded-full flex gap-2 shadow-2xl z-50 pointer-events-auto">
      {states.map(state => (
        <button
          key={state}
