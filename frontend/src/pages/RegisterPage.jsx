    ...
    <div className="flex items-center justify-center min-h-screen bg-[#111] text-white font-sans">
      <div className="w-full max-w-md p-8 space-y-6 bg-[#1a1a1a] rounded-xl shadow-2xl border border-gray-800">
        <div className="text-center">
          ...
          <p className="text-gray-400 mt-2 text-sm">Join FightFireWithAI</p>
        </div>
        ...
        <p className="text-center text-gray-400 mt-6 text-sm">
          Already have an account? <Link to="/" className="text-[#7F77DD] hover:text-[#958df0] font-medium hover:underline transition-colors">Login</Link>
        </p>
      </div>
    </div>
  );
